...
enum EquipmentArt {
  ...
  const EquipmentArt(this.label, this.spanishLabel);
  final String label;
  ...
  Rect get sourceRect => _subjectBounds[index];
}
...
// Full stable IDs from scripts/seed-checklists.js. Never match UUID suffixes.
