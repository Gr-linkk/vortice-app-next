...
-- NOTE: Create the 'signatures' and 'service-report-photos'
-- buckets in Storage UI first if they don't exist yet.
...
--    (READ policies already exist; INSERT was missing — blocks Add Part)
-- ============================================================
...
-- ============================================================
-- 7. profiles — add subscription_tier column
-- ============================================================
